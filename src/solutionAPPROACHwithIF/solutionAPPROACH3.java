...
private static String getNUMBER_LINE(int k, int mAXLENGTHHYPHON, int[] A, int rowcount) {
	String returnSTNG = "";	
...
//____________________________________________________________________
	private static void printME(String borderLINE) {
		System.out.println(borderLINE);		
	}
	private static String getNUMBLINE2(int k, int mAXLENGTHHYPHON, int [] A, int rowcount, int numROWS) {//k times 
		String returnSTNG = "|";
	...
	private static void printBORDER(int [] array, int MAXLENGTHHYPHON,  int blocks) {		
...
//______________________------
	private static String getPADDED_NUM(int someNUMBER , int MAXLENGTHHYPHON ) {

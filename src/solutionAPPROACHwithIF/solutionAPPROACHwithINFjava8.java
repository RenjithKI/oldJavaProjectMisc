...
public interface solutionAPPROACHwithINFjava8 {
	void solutionMain(int [] A, int K);
	// ********* in java 8 you can have static methods  wowwwww
...
static String getNUMBER_LINE(int k, int mAXLENGTHHYPHON, int[] A, int rowcount) {
	String returnSTNG = "";	
...
//____________________________________________________________________
	static void printME(String borderLINE) {
		System.out.println(borderLINE);		
	}
	static String getNUMBLINE2(int k, int mAXLENGTHHYPHON, int [] A, int rowcount, int numROWS) {//k times 
		String returnSTNG = "|";
	...
	static String getborderLINE(int k, int mAXLENGTHHYPHON) {//k times 
		String returnSTNG = "";
		for (int i = 0; i < k; i++) {
	...
	static void printBORDER(int [] array, int MAXLENGTHHYPHON,  int blocks) {		
...
//______________________------
	static String getPADDED_NUM(int someNUMBER , int MAXLENGTHHYPHON ) {
